...
router.post("/create", identityManager(["admin"], {}), async (req, res) => {
...
router.get("/list", identityManager(["admin", "user"], {}), async (req, res) => {
    let criteria = {};
...
router.put("/update", identityManager(["admin"], {}), async (req, res) => {
...
router.delete("/delete/:faqId", identityManager(["admin"], {}), async (req, res) => {
